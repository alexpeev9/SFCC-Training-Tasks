...
module.exports = {
    ...
    updateAttributesAndDetails: function () {
        $("body").on("product:statusUpdate", function (e, data) {
            $(".js-productId-input").val(data.id); // bind to hidden input
            const form = $(".js-subscribe-product-wrapper");
            form.removeClass(
                !data.readyToOrder && data.available ? "d-none" : "d-block"
            );
            form.addClass(
                data.readyToOrder && !data.available ? "d-block" : "d-none"
            );
